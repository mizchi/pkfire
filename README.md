...
> **Why `@v0.5.0` and not `@pkfire@0.14.0`?** GitHub Actions cannot
...
| --- | --- | --- |
| Pkl package (recommended) | `amends "package://pkg.pkl-lang.org/github.com/mizchi/pkfire/pkfire@0.14.0#/Taskfile.pkl"` | Versioned, integrity-checked, cached by Pkl. |
...
| HTTPS, pinned tag | `amends "https://raw.githubusercontent.com/mizchi/pkfire/pkfire@0.14.0/pkl/Taskfile.pkl"` | Pinned to a release tag, no package resolution. |
